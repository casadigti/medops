        ...
        <div className="p-3 border border-amber-100 bg-amber-50 rounded-xl">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="Nueva temporal (opcional, mín. 8 caracteres)"
              minLength={8}
              value={form.password}
          ...
          <p className="text-[10px] text-amber-700 mt-1">
            Si escribes una contraseña, se forzará el cambio al entrar. Mínimo 8 caracteres.
            {form.password && form.password.length > 0 && form.password.length < 8 && (
              <span className="text-red-600 font-bold ml-1">({form.password.length}/8)</span>
            )}
          </p>
        </div>
      )}
